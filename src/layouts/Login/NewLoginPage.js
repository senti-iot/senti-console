...
import { ItemG, TextF, T } from 'components';
import { Hidden, Paper, withStyles, InputAdornment, Button } from '@material-ui/core';
				...
				<ItemG container>
					<ItemG xs={12} sm={12} md={4} lg={4} xl={3} container>
						<Paper className={classes.paper}>
							<ItemG container alignItems={'center'} justify={'center'} className={classes.container}>
