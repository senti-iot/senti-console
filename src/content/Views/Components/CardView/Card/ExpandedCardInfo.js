		...
		return (
			<Modal {...this.props} handleOverlay={this.props.handleOverlay}>
				{this.state.project ? <React.Fragment>
					<ExpFormImg src={project.img ? project.img : 'https://picsum.photos/1920/1404/?random=0'} />
					<ExpHeader>
						...
						<ExpSection>
							...
							<ExpProjectInfo>
								{project.registrations ?
									project.registrations.map((r, i) =>
										<ExpProjectInfoItem key={i} style={{ justifyContent: 'center' }}>
