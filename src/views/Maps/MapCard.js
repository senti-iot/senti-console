		...
		return <Fragment>
			...
			<Dropdown menuItems={
				[
					...
					{ dontShow: this.props.device ? false : true, label: t('actions.editLocation'), selected: this.state.editLocation, icon: EditLocation, func: () => this.handleOpenConfirmEditLocation() }
				]
			} />
